...
include('../../header.php');
	...
	if(isset($_SESSION['user_info']) && isset($_SESSION['orderSaved'])){
		if($_SESSION['orderSaved'] == 1){
			...
			$_POST = array();
			$status = true;
			$statusMessage = "Uspešno sačuvan nalog za isplatu.";
            ...
            <form method="POST" name="orderForm" action="<?PHP echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
				...
				?>				
					...
					if(isset($_SESSION['user_info']))
						echo '<input type="button" value="Sačuvaj isplatnicu" id="saveOrder" title="Možete sačuvati nalog za isplatu u Vašem nalogu">';
					?>
